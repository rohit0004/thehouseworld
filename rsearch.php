...
?>
<?php
 $sql="SELECT *FROM  addproperty,addimage where addproperty.id=addimage.pid AND place='Rajendra nagar';";
?>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<div class="col-lg-4 col-md-6 mb-4">
					...
					<a href="details.php?id=<?php echo $row['id'];?>" class="feature-item">
						...
						<div class="feature-text">
							...
							<div  class="room-price">Rs.<?php echo $row['state'];?> ,<?php echo $row['state'];?></div>
					</div>
					</a>
				</div>
					 <?php
